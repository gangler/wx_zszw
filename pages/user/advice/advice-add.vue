<template>
	<view>
		...
		<cu-custom v-else-if="flag == 2" class="bg-blue" style="background-color: #215D80;" :isBack="true"><block slot="backText"></block><block slot="content">问题描述</block></cu-custom>
		...
		<form @submit="formSubmit">
			...
			<view class="padding flex flex-direction">
				<button form-type="submit" class="cu-btn bg-grey lg" style="background-color: #215D80;">提交</button>
			</view>
		</form>
	</view>
</template>
